...
createHistogramWithoutNA(ConsolidatedData$direction_du_vecteur_de_vent_max,breaks=seq(-.5,15.5,1))
...
createHistogramWithoutNA(ConsolidatedData$direction_du_vecteur_vent_moyen,breaks=seq(-0.5,511.5,2))

#Occurence of Zero is around .9 million so creating histogram without Zero 
createHistogramWithoutNAandZero(ConsolidatedData$direction_du_vecteur_vent_moyen,breaks=seq(0.5,510.5,2))
...
createHistogramWithoutNA(ConsolidatedData$direction_du_vecteur_de_vent_max_en_degres,breaks=seq(-0.5,360,22.5))
